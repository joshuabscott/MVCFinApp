...
namespace MVCFinApp.Controllers
{
    ...
    public class ChartsController : Controller
    {
        ...
        public ChartsController(ApplicationDbContext context, UserManager<FAUser> userManager)
        {
            _context = context;
        ...
        {
            var list = new List<BudgetPieChartData>();
